...
"""Constants for the engines. This file has been adapted from the searchless chess paper implementation."""
...
# from src.searchless_chess.engines import stockfish_engine
from searchless_chess.engines import lc0_engine

from leela_interp import Lc0sight
from leela_logit_lens import LeelaLogitLens, LogitLensEngine
from leela_logit_lens.tools.utils import set_device
...
def create_policy_net_builder():
    """Create the policy net engine builder as implemented in the searchless chess paper."""
    return {
...
def create_logit_lens_builders(model_path: str):
    """Create logit lens engine builders with the specified model path."""
    return {
...
# Start with empty ENGINE_BUILDERS
ENGINE_BUILDERS = {}

# These are engine Builders for the other engines from the searchless chess paper
...
# These are other possible engines from the searchless chess paper
