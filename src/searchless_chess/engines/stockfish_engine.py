...
"""Implements a stockfish engine. This file is from the searchless chess paper."""
...
class StockfishEngine(engine.Engine):
  ...
  def __init__(
    ...
    # Altered. Original is a hardcoded path.
    # bin_path = '/leela-logit-lens/searchless_chess/Stockfish/src/stockfish'
